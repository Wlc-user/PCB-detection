...
| 指标 | 数值 | 说明 |
|------|------|------|
| **mAP50** | 0.932 | IoU=0.5时的平均精度 |
| mAP50-95 | 0.879 | 多IoU阈值平均精度 |
| **Precision** | 0.917 | 精确率 |
| **Recall** | 0.951 | 召回率 |
...
|---------|-----------|--------|-------|
| missing_hole | 0.952 | 0.950 | 0.943 |
| mouse_bite | 0.924 | 0.965 | 0.923 |
| open_circuit | 0.911 | 0.943 | 0.904 |
| **short** | **0.934** | 0.914 | **0.937** |
| spur | 0.893 | 0.955 | 0.928 |
| spurious_copper | 0.917 | 0.862 | 0.942 |
